...
where opening_dt >= date'2006-12-19'
...
-- Alle contracten voor 20061219 op inzichtsmoment 20061220 inderteren*/


insert into s_dm_cdo.vr_rekening
select 
base.contract_oid
,rek_nr
--,klant_nr as klant_nr_brek
...
--- table voor onderzoek
drop table s_dm_cdo.vr_rekening_voor20061219;


create table s_dm_cdo.vr_rekening_voor20061219
as
(
select 
base.contract_oid
