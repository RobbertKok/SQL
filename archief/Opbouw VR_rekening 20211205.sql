...
drop table s_dm_cdo.vr_rekening2;

create table s_dm_cdo.vr_rekening2
as
(
select 
base.contract_oid
...
,pi.dlk_deb_perc_5
,pi.dlk_kred_grens_5
,case when zeroifnull(aq.kred_limiet) <> 0 then aq.kred_limiet else rk.kred_limiet end as inp_kred_limiet
,pi2.deb_perc
...
,(perc_huidige_rsc_bij_afsluiten_contract + zeroifnull(pi2.deb_perc)) as aanvangs_rte_maand_perc
